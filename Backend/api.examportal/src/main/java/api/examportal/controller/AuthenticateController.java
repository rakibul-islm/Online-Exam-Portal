...
import api.examportal.config.JwtUtil;
import api.examportal.helper.UserNotFoundException;
import api.examportal.model.JwtRequest;
import api.examportal.model.JwtResponse;
...
public class AuthenticateController {
	...
	public User getCurrentUser(Principal principal) {
		return ((User) this.detailServiceImpl.loadUserByUsername(principal.getName()));
